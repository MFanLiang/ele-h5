/**
 * 对 axios 进行二次自定义封装
 * axios 实例的类型为 AxiosInstance，请求需要传入的参数类型为 AxiosRequestConfig，响应的数据类型为 AxiosResponse，
 * InternalAxiosRequestConfig 继承于 AxiosRequestConfig
 */
...
// 扩展 InternalAxiosRequestConfig，让每个请求都可以控制是否需要 loading 加载态
...
interface InterceptorHooks {
  ...
  ) => RequestInternalAxiosRequestConfig;
